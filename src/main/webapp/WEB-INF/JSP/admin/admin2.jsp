...
<div class="row">
    ...
    <div class="col col-lg-7 col-xl-7">
        <label id="sayingLabel" for="sayingTxt">老师寄语<br>
            <small class="text-muted" id="groupNameLabel">同学们登录网页时，将会看到老师寄语</small>
        </label>
    ...
    <div class="col-12 col-xl-7 offset-xl-0 col-lg-7">
        <input class="btn btn-primary col-6 float-right col-sm-4 col-md-3 col-lg-4" type="submit" name="new" value="开始新的作业" onclick="startModal(this)">
    </div>
</div>